...
const REMINDER_FNAME: string = "reminders.json";
...
export class Reminder {
  ...
  save() {
    ...
    fs.writeFileSync(REMINDER_FNAME, JSON.stringify(comboRemi));
  }
}
...
export class ReminderLoader {
  ...
  getReminderByNum(num: number): Reminder {
